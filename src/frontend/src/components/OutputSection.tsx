...
export default function OutputSection({ clipPathPath, clipPathPolygon, pathError, polygonError }: OutputSectionProps) {
  ...
  return (
    <Card className="shadow-lg">
      ...
      <CardContent>
        <Tabs defaultValue={hasPathOutput ? "path" : "polygon"} className="w-full">
          ...
          <TabsContent value="path" className="space-y-4">
            {hasPathOutput ? (
              ...
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  Path format is unavailable. {pathError || 'Conversion failed.'}
                </AlertDescription>
              </Alert>
            )}
          </TabsContent>
          ...
          <TabsContent value="polygon" className="space-y-4">
            {hasPolygonOutput ? (
              ...
              <Alert variant="destructive">
                <AlertCircle className="h-4 w-4" />
                <AlertDescription>
                  Polygon format is unavailable. {polygonError || 'Conversion failed.'}
                </AlertDescription>
              </Alert>
            )}
          </TabsContent>
